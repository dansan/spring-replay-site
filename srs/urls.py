...
urlpatterns = [url(r'^$', srs.views.index),
               url(r'^index_replay_range/(?P<range_end>[\d]+)/(?P<game_pref>[\d]+)/$', srs.views.index_replay_range,
                   name="index_replay_range"),
               ...
               url(r'^comment_tbl_src$', srs.ajax_views.CommentDTView.as_view(), name='comment_tbl_src$'),
               url(r'^comments/', include('django_comments.urls')),
               url(r'^download/(?P<gameID>[0-9a-f]+)/$', srs.views.download),
               url(r'^admin/', include(admin.site.urls)),
               url(r'^xmlrpc/$', django_xmlrpc.views.handle_xmlrpc, name='xmlrpc'),
               url(r'^maplinks_modal/(?P<gameID>[0-9a-f]+)/$', srs.ajax_views.maplinks_modal, name="maplinks_modal"),
               url(r'^modlinks_modal/(?P<gameID>[0-9a-f]+)/$', srs.ajax_views.modlinks_modal, name="modlinks_modal"),
               ...
               url(r'^browse_tbl_src$', srs.ajax_views.BrowseReplaysDTView.as_view(), name='browse_tbl_src'),
               ...
               url(r'^edit_replay/(?P<gameID>[0-9a-f]+)/$', srs.views.edit_replay),
