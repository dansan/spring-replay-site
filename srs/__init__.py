...
ro.setFormatter(logging.Formatter(fmt=settings.DEBUG_FORMAT, datefmt=settings.DATETIME_FORMAT))
logger.addHandler(ro)

logger = logging.getLogger("django")
dj = logging.FileHandler(settings.LOG_PATH+'/django_info.log')
dj.setLevel(logging.INFO)
dj.setFormatter(logging.Formatter(fmt=settings.INFO_FORMAT, datefmt=settings.DATETIME_FORMAT))
...
l2.setFormatter(logging.Formatter(fmt=settings.INFO_FORMAT, datefmt=settings.DATETIME_FORMAT))
