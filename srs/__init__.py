...
dj = TimedRotatingFileHandler(os.path.join(settings.LOG_PATH, 'django_info.log'), when='d', interval=1, backupCount=14)  # type: logging.Handler
...
l1 = TimedRotatingFileHandler(os.path.join(settings.LOG_PATH, 'srs_debug.log'), when='d', interval=1, backupCount=14)  # type: logging.Handler
