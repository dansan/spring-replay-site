    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "bug",
                    models.PositiveIntegerField(default=0, verbose_name=b"Bug Hunter"),
                ),
                (
                    "cap",
                ...
                (
                    "emp",
                    models.PositiveIntegerField(default=0, verbose_name=b"Stun Wizard"),
                ),
                (
                    "fire",
                ...
                (
                    "herokill",
                    models.PositiveIntegerField(default=0, verbose_name=b"Hero Hunter"),
                ),
                (
                    "hover",
                ...
                (
                    "pwn",
                    models.PositiveIntegerField(default=0, verbose_name=b"Total Pain"),
                ),
                (
                    "rezz",
                ...
                (
                    "share",
                    models.PositiveIntegerField(default=0, verbose_name=b"Share Bear"),
                ),
                (
                    "shell",
                ...
                (
                    "slow",
                    models.PositiveIntegerField(default=0, verbose_name=b"Traffic Cop"),
                ),
                (
                    "sweeper",
