    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('media_magic_text', models.CharField(blank=True, max_length=1024, null=True)),
                ('media_magic_mime', models.CharField(blank=True, max_length=128, null=True)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('developer', models.ManyToManyField(blank=True, to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'ordering': ['name'],
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('game', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='srs.Game')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('metadata', picklefield.fields.PickledObjectField(blank=True, editable=False, null=True)),
            ],
            options={
                'ordering': ['name'],
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('startpostype', models.IntegerField(blank=True, null=True, verbose_name=b'-1 means full image')),
                ('map_info', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='srs.Map')),
            ],
        ),
        migrations.CreateModel(
            name='MapModOption',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('match_type', models.CharField(choices=[(b'1', '1v1'), (b'T', 'Team'), (b'F', 'FFA'), (b'G', 'TeamFFA'), (b'L', 'Global')], db_index=True, max_length=1)),
                ('playername', models.CharField(blank=True, db_index=True, max_length=128, null=True)),
                ('trueskill_mu', models.FloatField(default=25.0)),
                ('trueskill_sigma', models.FloatField(default=8.333333333333334)),
                ('game', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='srs.Game')),
                ('playeraccount', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='srs.PlayerAccount')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('trueskill_mu', models.FloatField(default=25.0)),
                ('trueskill_sigma', models.FloatField(default=8.333333333333334)),
                ('match_date', models.DateTimeField(blank=True, db_index=True, null=True)),
                ('game', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='srs.Game')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('unixTime', models.DateTimeField(db_index=True, verbose_name=b'date of match')),
                ('wallclockTime', models.CharField(max_length=32, verbose_name=b'length of match')),
                ('autohostname', models.CharField(blank=True, db_index=True, max_length=128, null=True)),
                ...
                ('map_img', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='srs.MapImg')),
                ('map_info', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='srs.Map')),
            ],
            options={
                'ordering': ['-upload_date'],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('account', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='srs.PlayerAccount')),
                ('leaderboard', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='srs.SldbLeaderboardGame')),
            ],
            options={
                'ordering': ['rank'],
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('num', models.SmallIntegerField()),
                ('allyteam', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='srs.Allyteam')),
                ('replay', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='srs.Replay')),
                ('teamleader', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='+', to='srs.Player')),
            ],
        ),
        migrations.CreateModel(
            name='UploadTmp',
        ...
        migrations.CreateModel(
            name='MapOption',
            fields=[
                ('mapmodoption_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='srs.MapModOption')),
            ],
        ...
        migrations.AddField(
            model_name='player',
            name='account',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='srs.PlayerAccount'),
        ),
        migrations.AddField(
            model_name='player',
            name='replay',
        ...
        migrations.AddField(
            model_name='player',
            name='team',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='srs.Team'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='bawards',
            name='cowAward',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='+', to='srs.Player'),
        ),
        migrations.AddField(
            model_name='bawards',
            name='dmgRecAward',
