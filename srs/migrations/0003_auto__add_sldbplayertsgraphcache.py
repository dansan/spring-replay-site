...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'SldbPlayerTSGraphCache'
        db.create_table(u'srs_sldbplayertsgraphcache', (
            ...
            ('filepath_global', self.gf('django.db.models.fields.CharField')(max_length=256)),
            ('filepath_duel', self.gf('django.db.models.fields.CharField')(max_length=256)),
            ('filepath_ffa', self.gf('django.db.models.fields.CharField')(max_length=256)),
            ('filepath_team', self.gf('django.db.models.fields.CharField')(max_length=256)),
            ('filepath_teamffa', self.gf('django.db.models.fields.CharField')(max_length=256)),
        ))
        db.send_create_signal(u'srs', ['SldbPlayerTSGraphCache'])


    def backwards(self, orm):
        # Deleting model 'SldbPlayerTSGraphCache'
        db.delete_table(u'srs_sldbplayertsgraphcache')
    ...
    models = {
        ...
        u'srs.sldbplayertsgraphcache': {
            'Meta': {'object_name': 'SldbPlayerTSGraphCache'},
            'account': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['srs.PlayerAccount']"}),
            'filepath_duel': ('django.db.models.fields.CharField', [], {'max_length': '256'}),
            'filepath_ffa': ('django.db.models.fields.CharField', [], {'max_length': '256'}),
            'filepath_global': ('django.db.models.fields.CharField', [], {'max_length': '256'}),
            'filepath_team': ('django.db.models.fields.CharField', [], {'max_length': '256'}),
            'filepath_teamffa': ('django.db.models.fields.CharField', [], {'max_length': '256'}),
            'game': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['srs.Game']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_modified': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'})
        },
